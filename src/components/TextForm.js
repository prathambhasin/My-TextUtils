...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container">
            ...
            <button disabled={text.length===0} className="btn btn-primary my-2 mx-2" onClick={handleTrimClick}>Trim Text </button>
            <button disabled={text.length===0} className="btn btn-primary my-2 mx-2" onClick={capitalize}>Capitalize </button>
